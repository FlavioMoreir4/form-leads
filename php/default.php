...
<head>
    <title>API IPMIL</title>
    <meta charset="utf-8">
    <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    <meta content="Página padrão" name="description">
    <meta content="width=device-width, initial-scale=1" name="viewport">
    <meta name="description"
        content="Sua conta foi criada na Hostinger. Comece agora a utilizar seu sistema de hospedagem de sites Hostinger.">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="/." rel="nofollow"><i aria-hidden="true"
                                class="fa fa-home"></i> Pagina Inicial</a>
                    </li>
                    <!--li>
                        <a href="https://www.hostinger.com.br/programa-de-afiliados" rel="nofollow"><i
                                aria-hidden="true" class="fa fa-trophy"></i> Ganhe Conosco</a>
                    </li>
                    <li>
                        <a href="https://www.hostinger.com.br/afiliados-brasil/login" rel="nofollow"><i
                                aria-hidden="true" class="fa fa-user"></i> Afiliados</a>
                    </li>
                    <li>
                        <a href="https://www.hostinger.com.br/cpanel-login" rel="nofollow"><i aria-hidden="true"
            ...
            <div class="footer">
                <div class="row">
                    <div class="copyright text-center">
                        Instituto Padrão Militar © 2020. Todos os direitos reservados
                    </div>
                </div>
            </div>
        </div>

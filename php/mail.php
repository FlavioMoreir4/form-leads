<?php
    ...
    $sendWhatsapp = preg_replace("/[^0-9]/", "", $_POST["whatsapp"]);
    $mensagem = nl2br($_POST["mensagem"], false);
                                                            ...
                                                            <table width='600' cellpadding='0' cellspacing='0' border='0'
                                                                ...
                                                                <tr>
                                                                    <td align='center' class='hund' width='600'>
                                                                        <img src='https://via.placeholder.com/1200x160/eeeeee?text=Instituto%20Padr%C3%A3o%20Militar'
                                                                            width='300' alt='Logo' border='0'
                                                            ...
                                                            <table width='600' cellpadding='0' cellspacing='0' border='0'
                                                                ...
                                                                <tr>
                                                                    <td align='center' class='hund ripplelink' width='600'>
                                                                        <img align='center' width='600'
                                                                            ...
                                                                            class='hund'
                                                                            src='http://paulgoddarddesign.com/emails/images/material-design/material.gif'>
                                                                    </td>
                                                                </tr>
                                                                <!-- END HEADER IMAGE -->
                                                                <!-- START BODY COPY -->
                                                                <tr>
                                                                    <td class='td-padding' align='left'
                                                                        style='font-family: Roboto, monospace; color: #212121!important; line-height: 30px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 13px;'>
                                                                        <h2 style='font-size: 32px;    margin-block-end: -0.80em;'>$nome</h2>
                                                                        <p style='font-size: 22px;'>$whatsapp <br>$email
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class='td-padding' align='left'
                                                                        style='font-family: Roboto, monospace; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;'>
                                                                        $mensagem
                                                                    </td>
                                                                </tr>
                                                                <!-- END BODY COPY -->
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align='left'
                                                                                                ...
                                                                                                <a class='button raised'
                                                                                                    href='mailto:$email'
                                                                                                    style='font-size: 14px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 10px 25px; border: 1px solid #17bef7; display: inline-block;'>RESPONDER</a>
                                                                                            </td>
                                                                                            <td align='right'
                                                                                                style='border-radius: 3px;'
                                                                                                bgcolor='#17f7a1'>
                                                                                                <a class='button raised'
                                                                                                    href='https://wa.me/55$sendWhatsapp'
                                                                                                    target='_blank'
                                                                                                    style='font-size: 14px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 10px 25px; border: 1px solid #17f7a1; display: inline-block;'>RESPONDER VIA WHATSAPP</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </td>
                                                ...
                                                <table width='600' cellpadding='0' cellspacing='0' border='0' class='container'>
                                                    <tr>
                                                        <td class='td-padding' align='center'
                                                            style='font-family: Roboto, monospace; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 0px; padding-left: 0px!important; padding-right: 0px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 0px 0px 0px 0px;'>
                                                            &copy; 2020 - Instituto Padrão Militar
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
    ...
    echo "$nome, $email, $whatsapp, $emailDestinatario";
?>